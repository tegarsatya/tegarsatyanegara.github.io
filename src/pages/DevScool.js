...
const cards = [
    {
        imageUrl: 'https://devschool.id/sites/devschool//themes/devschool/assets/img/gallery_6.jpg',
    ...
    {
        imageUrl: 'https://devschool.id/sites/devschool//themes/devschool/assets/img/gallery_1.jpg',
    ...
    <div className="container">
        ...
        <div className="row" style={{marginTop: 40, marginBottom: 100}}>
            ...
            <div className="col-md-6">
                <img 
                    src="https://devschool.id/sites/devschool//themes/devschool/assets/img/gallery_5.jpg"
                    alt=""
                />
            </div>
        </div>
